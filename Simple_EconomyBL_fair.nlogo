...
to go
  ...
  ask turtles with [ (wealth > 0 ) and (wealth <= 30) ] [transact_poor ]
...
It is a thought experiment of a world where, in every time steps depending on the current wealth, each agent gives a certain amount of money to one other person (at random) if they have any money to give. If a person has a wealth between 0 and 30 $, the person is considered as poor. If a person has a wealth between 30 and 80 $, the person is considered as medium wealth If a person has a wealth larger than 80 $, the person is considered as rich.
If a person is in the poor class, the person will give 1 $ to one other person (at random) Similarly, if a person is in the medium class, the person will give 5 $ to one other person. If the person is rich, she will give 10 $ to one other person. If they have no money then they do not give out any money.

## HOW IT WORKS

The SETUP for the model creates 500 agents, and then gives them each 100 dollars. At each tick, they give a certain amount of money (1, 5 or 10) depending in which classes they belong (poor, medium, or rich). If they have no money then they do nothing. Each agent also moves to an x-coordinate equal to its wealth.
